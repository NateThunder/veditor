...
partial class Form1
{
    ...
    private void InitializeComponent()
    {
        ...
        btnBrowseOutput = new VeditorWindow.UI.ClayButton();
        chkExtractAudio = new VeditorWindow.UI.ClayCheckBox();
        btnDownload = new VeditorWindow.UI.ClayButton();
        grpAudioConvert = new GroupBox();
        btnConvertM4a = new VeditorWindow.UI.ClayButton();
        btnConvertWav = new VeditorWindow.UI.ClayButton();
        btnConvertMp3 = new VeditorWindow.UI.ClayButton();
        ...
        trkVideoQuality = new VeditorWindow.UI.PurpleSlider();
        lblVideoQualityValue = new Label();
        lblVideoQualityCaption = new Label();
        btnConvertMov = new VeditorWindow.UI.ClayButton();
        btnConvertMkv = new VeditorWindow.UI.ClayButton();
        btnConvertMp4 = new VeditorWindow.UI.ClayButton();
        ...
        btnOpenExternal = new VeditorWindow.UI.ClayButton();
        btnOpenMediaFile = new VeditorWindow.UI.ClayButton();
        btnPreviewLast = new VeditorWindow.UI.ClayButton();
        tabLog = new TabPage();
        txtLog = new TextBox();
    ...
    private VeditorWindow.UI.PurpleSlider trkVideoQuality;
